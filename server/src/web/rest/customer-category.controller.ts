...
@ApiBearerAuth()
@ApiUseTags('customer-categories')
export class CustomerCategoryController {
    ...
    @PostMethod('/')
    @Roles(RoleType.USER)
    @ApiOperation({ title: 'Create customerCategory' })
    @ApiResponse({
        status: 201,
    ...
    @Put('/')
    @Roles(RoleType.USER)
    @ApiOperation({ title: 'Update customerCategory' })
    @ApiResponse({
        status: 200,
    ...
    @Delete('/:id')
    @Roles(RoleType.USER)
    @ApiOperation({ title: 'Delete customerCategory' })
    @ApiResponse({
        status: 204,
