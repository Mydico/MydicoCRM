...
export class Config {
    ...
    'jhipster.mail.from' = 'MydicoCRM@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'MydicoCRM API';
    'jhipster.swagger.description' = 'MydicoCRM API documentation';
    ...
    'eureka.instance.appname' = 'MydicoCRM';
    'eureka.instance.instanceId' = 'MydicoCRM:${random.value}';
