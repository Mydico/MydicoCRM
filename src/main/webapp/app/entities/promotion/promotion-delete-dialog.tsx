...
export const PromotionDeleteDialog = (props: IPromotionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mydicoCrmApp.promotion.delete.question">Are you sure you want to delete this Promotion?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-promotion" color="danger" onClick={confirmDelete}>
