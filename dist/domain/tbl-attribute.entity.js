 ...
 * A TblAttribute.
 */
let TblAttribute = class TblAttribute extends base_entity_1.BaseEntity {
};
__decorate([
    typeorm_1.Column({ name: 'name', length: 255, nullable: true }),
    __metadata("design:type", String)
], TblAttribute.prototype, "name", void 0);
__decorate([
    typeorm_1.Column({ type: 'boolean', name: 'is_del', nullable: true }),
    __metadata("design:type", Boolean)
], TblAttribute.prototype, "isDel", void 0);
__decorate([
    typeorm_1.Column({ type: 'integer', name: 'site_id', nullable: true }),
    __metadata("design:type", Number)
], TblAttribute.prototype, "siteId", void 0);
__decorate([
    typeorm_1.ManyToOne(type => tbl_product_entity_1.default),
    __metadata("design:type", tbl_product_entity_1.default)
], TblAttribute.prototype, "product", void 0);
TblAttribute = __decorate([
    typeorm_1.Entity('tbl_attribute')
], TblAttribute);
exports.default = TblAttribute;
//# sourceMappingURL=tbl-attribute.entity.js.map