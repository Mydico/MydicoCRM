...
const user_token_entity_1 = __importDefault(require("../../domain/user-token.entity"));
...
let UserTokenController = class UserTokenController {
    constructor(userTokenService) {
        ...
        this.logger = new common_1.Logger('UserTokenController');
    }
    async getAll(req) {
    ...
    async post(req, userToken) {
        const created = await this.userTokenService.save(userToken);
        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'UserToken', created.id);
        return created;
    }
    async put(req, userToken) {
        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'UserToken', userToken.id);
        return await this.userTokenService.update(userToken);
    }
    async remove(req, id) {
        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'UserToken', id);
...
__decorate([
    ...
    swagger_1.ApiResponse({
        ...
        type: user_token_entity_1.default
    }),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserTokenController.prototype, "getAll", null);
__decorate([
    common_1.Get('/:id'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiResponse({
    ...
    __metadata("design:returntype", Promise)
], UserTokenController.prototype, "getOne", null);
__decorate([
    common_1.Post('/'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Create userToken' }),
    swagger_1.ApiResponse({
        status: 201,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, user_token_entity_1.default]),
    __metadata("design:returntype", Promise)
], UserTokenController.prototype, "post", null);
__decorate([
    common_1.Put('/'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Update userToken' }),
    swagger_1.ApiResponse({
        status: 200,
    ...
    __metadata("design:paramtypes", [Object, user_token_entity_1.default]),
    __metadata("design:returntype", Promise)
], UserTokenController.prototype, "put", null);
__decorate([
    common_1.Delete('/:id'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Delete userToken' }),
    swagger_1.ApiResponse({
        status: 204,
    ...
    __metadata("design:returntype", Promise)
], UserTokenController.prototype, "remove", null);
UserTokenController = __decorate([
    common_1.Controller('api/user-tokens'),
    ...
    swagger_1.ApiUseTags('user-tokens'),
    __metadata("design:paramtypes", [user_token_service_1.UserTokenService])
], UserTokenController);
exports.UserTokenController = UserTokenController;
//# sourceMappingURL=user-token.controller.js.map