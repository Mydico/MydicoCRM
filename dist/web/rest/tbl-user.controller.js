...
const tbl_user_entity_1 = __importDefault(require("../../domain/tbl-user.entity"));
...
let TblUserController = class TblUserController {
    constructor(tblUserService) {
        ...
        this.logger = new common_1.Logger('TblUserController');
    }
    async getAll(req) {
    ...
    async post(req, tblUser) {
        const created = await this.tblUserService.save(tblUser);
        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'TblUser', created.id);
        return created;
    }
    async put(req, tblUser) {
        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'TblUser', tblUser.id);
        return await this.tblUserService.update(tblUser);
    }
    async remove(req, id) {
        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'TblUser', id);
...
__decorate([
    ...
    swagger_1.ApiResponse({
        ...
        type: tbl_user_entity_1.default
    }),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], TblUserController.prototype, "getAll", null);
__decorate([
    common_1.Get('/:id'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiResponse({
    ...
    __metadata("design:returntype", Promise)
], TblUserController.prototype, "getOne", null);
__decorate([
    common_1.Post('/'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Create tblUser' }),
    swagger_1.ApiResponse({
        status: 201,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, tbl_user_entity_1.default]),
    __metadata("design:returntype", Promise)
], TblUserController.prototype, "post", null);
__decorate([
    common_1.Put('/'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Update tblUser' }),
    swagger_1.ApiResponse({
        status: 200,
    ...
    __metadata("design:paramtypes", [Object, tbl_user_entity_1.default]),
    __metadata("design:returntype", Promise)
], TblUserController.prototype, "put", null);
__decorate([
    common_1.Delete('/:id'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Delete tblUser' }),
    swagger_1.ApiResponse({
        status: 204,
...
TblUserController = __decorate([
    common_1.Controller('api/tbl-users'),
