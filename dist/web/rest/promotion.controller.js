...
const promotion_entity_1 = __importDefault(require("../../domain/promotion.entity"));
...
let PromotionController = class PromotionController {
    constructor(promotionService) {
        ...
        this.logger = new common_1.Logger('PromotionController');
    }
    async getAll(req) {
    ...
    async post(req, promotion) {
        const created = await this.promotionService.save(promotion);
        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'Promotion', created.id);
        return created;
    }
    async put(req, promotion) {
        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'Promotion', promotion.id);
        return await this.promotionService.update(promotion);
    }
    async remove(req, id) {
        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'Promotion', id);
...
__decorate([
    ...
    swagger_1.ApiResponse({
        ...
        type: promotion_entity_1.default
    }),
...
__decorate([
    common_1.Post('/'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Create promotion' }),
    swagger_1.ApiResponse({
        status: 201,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, promotion_entity_1.default]),
    __metadata("design:returntype", Promise)
], PromotionController.prototype, "post", null);
__decorate([
    common_1.Put('/'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Update promotion' }),
    swagger_1.ApiResponse({
        status: 200,
    ...
    __metadata("design:paramtypes", [Object, promotion_entity_1.default]),
    __metadata("design:returntype", Promise)
], PromotionController.prototype, "put", null);
__decorate([
    common_1.Delete('/:id'),
    security_1.Roles(security_1.RoleType.USER),
    swagger_1.ApiOperation({ title: 'Delete promotion' }),
    swagger_1.ApiResponse({
        status: 204,
...
PromotionController = __decorate([
    common_1.Controller('api/promotions'),
    ...
    swagger_1.ApiUseTags('promotions'),
