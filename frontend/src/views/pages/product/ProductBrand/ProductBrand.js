  ...
  return (
    <CCard>
      <CCardHeader>
        ...
        {(isAdmin || account.role.filter(rol => rol.method === 'POST' && rol.entity === '/api/product-brands').length > 0) && (
            ...
            show_details: item => {
              return (
                <td className="py-2 d-flex">
                  {(isAdmin || account.role.filter(rol => rol.method === 'PUT' && rol.entity === '/api/product-brands').length > 0) && (
                    <CButton
                      color="primary"
                      variant="outline"
                      shape="square"
