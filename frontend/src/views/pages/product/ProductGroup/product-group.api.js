...
export const updateProductGroup = createAsyncThunk('api/create/product-groups', async (body, thunkAPI) => {
  try {
...
export const getProductGroup = createAsyncThunk('api/product-groups', async (params = { page: 0, size: 20, sort: 'name,asc' }, thunkAPI) => {
  try {
