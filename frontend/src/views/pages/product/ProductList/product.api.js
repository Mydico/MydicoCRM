...
export const getProductBirthday = createAsyncThunk('api/products/birthday', async (params = { page: 0, size: 20, sort: 'createdDate,desc' }, thunkAPI) => {
  try {
...
export const getProductType = createAsyncThunk('api/product/product-types', async (params = { page: 0, size: 20, sort: 'name,asc' }, thunkAPI) => {
  try {
...
export const getProductStatus = createAsyncThunk('api/product/product-statuses', async (params = { page: 0, size: 20, sort: 'name,asc' }, thunkAPI) => {
  try {
