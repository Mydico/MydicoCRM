...
export const getPermissionGroups = createAsyncThunk('api/permission-groups', async (params = { page: 0, size: 20, sort: 'createdDate,desc' }, thunkAPI) => {
  try {
...
export const getPermissionType = createAsyncThunk('api/get/permission-type', async (params = { page: 0, size: 200, sort: 'createdDate,desc',status: "ACTIVE" }, thunkAPI) => {
  try {
...
export const getPermissions = createAsyncThunk('api/get/permission', async (params = { page: 0, size: 200, sort: 'createdDate,desc',status: "PUBLIC" }, thunkAPI) => {
  try {
