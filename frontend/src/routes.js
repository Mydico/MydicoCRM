...
const routes = [
  ...
  {path: '/receipts/:id/detail', name: 'Xem phiếu thu', component: ViewReceipt},
  ...
  {path: '/orders/:id/detail', name: 'Xem Đơn hàng', component: ViewOrder},
  ...
  {path: '/stores/import/return/:id/detail', name: 'Xem phiếu trả hàng', component: ViewWarehouseReturn},
